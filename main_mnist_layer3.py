...
class Net(nn.Module):
    def __init__(self):
        ...
        # 1st layer
        self.fc1 = BinarizeLinear(28*28,50)
        self.bn1 = nn.BatchNorm1d(50)
        self.relu1 = nn.ReLU()

        # 2nd layer
        self.fc2 = BinarizeLinear(50, 50)
...
def test():
    ...
    print("bn1_weights",bn1_weights.shape)
    for i in range(second_layer_size):
        val = round(bn1_weights[i].item(), 6)
        print(str(val)+"f"+", ", end='')
    print("\n--------------------------------------------------------------------------------")

    print("bn1_bias: ",bn1_bias.shape)
    for i in range(second_layer_size):
        val = round(bn1_bias[i].item(), 6)
        print(str(val)+"f"+", ", end='')
    ...
    print("bn1.running_var: ", bn1_running_var.shape)
    for i in range(second_layer_size):
        val = round(bn1_running_var[i].item(), 6)
        print(str(val)+"f"+", ", end='')
    ...
    bn2_weights = model.state_dict()['bn2.weight']
    bn2_bias = model.state_dict()['bn2.bias']
    ...
    print("bn2_weights",bn1_weights.shape)
    for i in range(second_layer_size):
        val = round(bn2_weights[i].item(), 6)
        print(str(val)+"f"+", ", end='')


    print("bn2_bias: ",bn2_bias.shape)
    for i in range(second_layer_size):
        val = round(bn2_bias[i].item(), 6)
        print(str(val)+"f"+", ", end='')
    ...
    print("bn2.running_var: ", bn1_running_var.shape)
    for i in range(second_layer_size):
        val = round(bn2_running_var[i].item(), 6)
        print(str(val)+"f"+", ", end='')
